                ...
                <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="userContact?userId=72">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
        						<form:form method="post" action="deleteUser" modelAttribute="user" >
        						<input type="hidden" value="${userId}" name="userId">
        							<div class="form-group row mb-3">
    									<label for="First Name" class="col-sm-2 col-form-label">Profile name</label>
    										<div class="col-sm-5">
      											<form:input class="form-control" path="profileName" id="profileName" />
      											<form:errors path="profileName" style="font-style: italic; color: red;"/>
    										</div>
    								</div>
    								<div class="form-group row mb-3">
    									<label for="Last Name" class="col-sm-2 col-form-label">User Name</label>
    										<div class="col-sm-5">
    								...
    								<div class="form-group row mb-3">
    								 ...
    								 <div class="col-sm-5">
                                            	...
                                            	<a class="btn btn-primary" href="viewUser?userId=72" role="button">Back</a>
                                            </div>
